    ...
    if agent is not None:
        ...
        if agent =='ppo':
            ...
            model = DDPG("MlpPolicy", env_train, learning_rate=learning_rate,
                        gradient_steps=10,batch_size=batch_size,
                        gamma=gamma, seed=seed)
        ...
        model_name = f"./data/models/{symbol}-week-" + s.strftime('%Y%m%d%H%M%S')
...
# # PPO Models: ./data/models/GBPUSD-week-20231126131448, ./data/models/GBPUSD-week-20231123194718.zip
# # A2C Models: ./data/models/GBPUSD-week-20231126185131, ./data/models/GBPUSD-week-20231126205306
# # 
...
model_name=f'./data/models/{symbol}-week-20231123194718.zip'
...
plt.savefig(f'trial_figures/forex_{symbol}_balance_a2c.jpg')
